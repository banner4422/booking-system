...
export default function AdminEvents({ events }: { events: IEventsDTO[] }) {
    ...
    return (
        <div className="py-6 lg:py-12 bg-gray-800">
            {events ?
                ...
                :
                <Fragment>
                    <p className='text-white mx-auto'>Ingen begivenheder planlagte. Lave begivenheder kommer snart!</p>
                </Fragment>
            }
        </div>
    )
